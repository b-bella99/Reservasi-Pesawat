...
<body>
    ...
    <header class="header dark-bg">
      ...
      <div class="nav search-row" id="top_menu">
        ...
        <ul class="nav top-menu">
          <li>
            <form class="navbar-form" method="post" action="cari_pelanggan.php">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-th-list"></i>Tampil Data Pelanggan</li>
            </ol>
          </div>
        </div>
        <p>Masukkan data <a href="form_insert_pelanggan.php">baru pelanggan</a></p>
         <p>
          <table width="853" border="1" align="center">
  <tr bgcolor="#FF9966">
    <td colspan="6"><div align="center" class="style1">Data Pelanggan </div></td>
  </tr>
  <tr>
    <td width="105"><div align="center">Id Pelanggan </div></td>
    <td width="185"><div align="center">Nama</div></td>
    <td width="200"><div align="center">Alamat</div></td>
    <td width="111"><div align="center">No Telepon </div></td>
    <td width="111"><div align="center">Jenis Kelamin </div></td>
  ...
  <tr>
    ...
    <td><a href='form_edit_pelanggan.php?id=<?php echo"$tampil[0]"; ?>'>Edit</a> | 
  <a href='delete_pelanggan.php?id=<?php echo"$tampil[0]"; ?>'>Delete</a></td>
  </tr>
  <?php
  }
  ?>
