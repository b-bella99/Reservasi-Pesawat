  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <p>
          <form name="form1" method="post" action="insert_pelanggan.php">
  <table width="296" border="1" align="center">
    <tr bgcolor="#CCCC66">
      <td colspan="3"><div align="center" class="style2">Form Insert Pelanggan </div></td>
    </tr>
    <tr>
      <td width="132">Id Pelanggan </td>
      <td width="3">:</td>
      <td width="139"><input name="id_customer" type="text" id="id_customer"></td>
    </tr>
    <tr>
      <td>Nama</td>
      <td>:</td>
    ...
    <tr>
      <td>No Telepon </td>
      <td>:</td>
      <td><input name="notelp" type="text" id="notelp"></td>
    </tr>
    <tr>
      <td>Jenis Kelamin </td>
      <td>:</td>
