...
<body>
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-th-list"></i>Cari Data Reservasi</li>
            </ol>
          </div>
        </div>
  ...
  <tr bgcolor="#C5C46D">
    <td colspan="6"><div align="center" class="style1">Data Cari Reservasi </div></td>
  </tr>
  <tr>
  ...
  $query=mysqli_query($connect, "select reservasi.id_reservasi,reservasi.tanggal,customer.nama,reservasi.nmr_kursi,rute.rute_ke
    from reservasi,customer,rute
     where customer.id_customer=reservasi.id_customer and reservasi.id_rute=rute.id_rute and id_reservasi like '%$_POST[cari]%' ");
