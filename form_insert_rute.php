        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-file-text-o"></i>Insert Data Rute</li>
            </ol>
          </div>
        </div>

        <p>
          <form name="form1" method="post" action="insert_rute.php">
  <table width="403" border="1" align="center">
    <tr bgcolor="#CCCC66">
      <td colspan="3"><div align="center" class="style2">Form Insert Rute </div></td>
    </tr>
    <tr>
      <td width="194">Id Rute</td>
      <td width="3">:</td>
      <td width="184"><input name="id_rute" type="text" id="id_rute"></td>
    </tr>
    <tr>
      <td>Asal Kota </td>
      <td>:</td>
      <td><input name="rute_dari" type="text" id="rute_dari"></td>
    </tr>
    <tr>
      <td>Tujuan Perjalanan </td>
      <td>:</td>
      <td><input name="rute_ke" type="text" id="rute_ke"></td>
    </tr>
    <tr>
      <td>Jam Berangkat </td>
      <td>:</td>
      <td><input name="jam_berangkat" type="text" id="jam_berangkat"></td>
    </tr>
    <tr>
      <td>Jam Sampai </td>
      <td>:</td>
      <td><input name="jam_tiba" type="text" id="jam_tiba"></td>
    </tr>
    <tr>
      <td>Harga</td>
      <td>:</td>
