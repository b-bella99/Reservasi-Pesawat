        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-file-text-o"></i>Update Data Rute</li>
            </ol>
          </div>
        </div>

        <p>
          <form name="form1" method="post" action="edit_rute.php">
            <?php
            $namaHost = "localhost";
            $username = "root";
            $password = "";
            ...
            $query=mysqli_query($connect, "select * from rute where id_rute='$_GET[id]'");
            $tampil=mysqli_fetch_array($query);
            ?>
  <table width="403" border="1" align="center">
    <tr bgcolor="#CCCC66">
      <td colspan="3"><div align="center" class="style2">Form Update Rute </div></td>
    </tr>
    <tr>
      <td width="194">Id Rute</td>
      <td width="3">:</td>
      <td width="184"><input name="id_rute" type="text" id="id_rute" value="<?php echo"$tampil[0]"; ?>" readonly="true"></td>
    </tr>
    <tr>
      <td>Asal Kota </td>
      <td>:</td>
      <td><input name="rute_dari" type="text" id="rute_dari" value="<?php echo"$tampil[1]"; ?>"></td>
    </tr>
    <tr>
      <td>Tujuan Perjalanan </td>
      <td>:</td>
      <td><input name="rute_ke" type="text" id="rute_ke" value="<?php echo"$tampil[2]"; ?>"></td>
    </tr>
    <tr>
      <td>Jam Berangkat </td>
      <td>:</td>
      <td><input name="jam_berangkat" type="text" id="jam_berangkat" value="<?php echo"$tampil[3]"; ?>"></td>
    </tr>
    <tr>
      <td>Jam Sampai </td>
      <td>:</td>
      <td><input name="jam_tiba" type="text" id="jam_tiba" value="<?php echo"$tampil[4]"; ?>"></td>
    </tr>
    <tr>
      <td>Harga</td>
      <td>:</td>
      <td><input name="harga" type="text" id="harga" value="<?php echo"$tampil[5]"; ?>"></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td><input type="submit" name="Submit" value="Submit"></td>
        ...
        <p>Kembali ke <a href="tampil_rute.php">tampil rute</a></p>
      </section>
