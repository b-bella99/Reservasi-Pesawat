...
<body>
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <p>
          <form name="form1" method="post" action="insert_reservasi.php">
  <table width="403" border="1" align="center">
    ...
    <tr>
      ...
      <td width="3">:</td>
      <td width="184"><input name="id_reservasi" type="text" id="id_reservasi"></td>
    </tr>
    <tr>
      <td>Tanggal</td>
      <td>:</td>
    ...
    {
    ?>
      <option value="<?php echo"$kolom[0]"; ?>"><?php echo"$kolom[0] - $kolom[1]"; ?></option>
    <?php
    }
    ?>
    </select></td>
    ...
    <tr>
      <td>Nomor kursi </td>
      <td>:</td>
      <td><input name="nmr_kursi" type="text" id="nmr_kursi"></td>
    </tr>
    <tr>
      <td>Id Rute </td>
      <td>:</td>
      <td><select name="id_rute" id="id_rute"><?php
    $namaHost = "localhost";
    $username = "root";
    $password = "";
    $database = "reservasi_pesawat";
