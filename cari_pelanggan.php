...
<body>
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-th-list"></i>Cari Data Pelanggan</li>
            </ol>
          </div>
        </div>
  ...
  <tr bgcolor="#C5C46D">
    <td colspan="6"><div align="center" class="style1">Data Cari Pelanggan</div></td>
  </tr>
  <tr>
  ...
  $query = mysqli_query($connect, "select * from customer where nama like '%$_POST[cari]%'");
